    ...
    <header className="bg-white shadow-md">
      <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="space-x-6">
          ...
          <Link href="#about" scroll={false} className="text-gray-700 hover:text-indigo-600 font-medium">About</Link>
          <Link href="#experience" scroll={false} className="text-gray-700 hover:text-indigo-600 font-medium">Experience</Link>
